...
void LinearGaugeSettingWidget::initGauge( AbstractGauge* pGauge )
{
    ...
    if ( linearGauge )
    {
        ...
        linearGauge->setOrientation(orientation);
        linearGauge->setScalePosition(scalePosition);
        linearGauge->setScale(ui->rangeMin->value(), ui->rangeMax->value());
...
void LinearGaugeSettingWidget::initFromGauge( AbstractGauge* pGauge )
{
    ...
    if ( linearGauge )
    {
        ...
        ui->rangeMin->setValue(linearGauge->lowerBound());
        ui->rangeMax->setValue(linearGauge->upperBound());
